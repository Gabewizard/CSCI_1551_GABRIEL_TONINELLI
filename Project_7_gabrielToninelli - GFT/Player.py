# GABRIEL F. TONINELLI - PROJECT7 - PLAYER FILE
import os, random, re
...
from SpaceJamClasses import Missile, Drone, SpaceStation, Orbiter, Laser
...
class Spaceship(SphereCollideObject, DirectObject.DirectObject):
    def __init__(self, loader, parent, traverser, pusher):
        ...
        # Laser — pass traverser to use CollisionRay hitscan
    ...
    def start_laser(self):
        ...
        if not taskMgr.hasTaskNamed("laser-task"):
            taskMgr.add(self.laser_task, "laser-task")
